...
There is no universal best relay. For the current Plainwire 2.2 code, Cloudflare has the cleanest managed integration and coturn has the cleanest self-hosted integration.
